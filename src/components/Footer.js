      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-lg font-semibold mb-4">About Todo App</h3>
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/add-todo" className="text-gray-300 hover:text-white text-sm transition-colors">
                  Add Todo
                </a>
              </li>
              <li>
                <a href="/completed" className="text-gray-300 hover:text-white text-sm transition-colors">
                  Completed
                </a>
              </li>
            </ul>
